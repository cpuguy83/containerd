...
type WriteContentRequest struct {
	...
	// PipePath is an optional field that can be set when you want to bypass
	// GRPC for the data path.
	//
	// If this field is set, and the server implementation can use it, it will
	// set the UsingPipePath field in the write response to true.
	// If the server can't use the pipe for whatever reason, the client must use
	// the GRPC stream for data.
	PipePath             string   `protobuf:"bytes,8,opt,name=pipe_path,json=pipePath,proto3" json:"pipe_path,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type WriteContentResponse struct {
	...
	// UsingPipePath will be set to true if the client set `PipePath` and the server impelementation will read content from that path.
	UsingPipePath        bool     `protobuf:"varint,7,opt,name=using_pipe_path,json=usingPipePath,proto3" json:"using_pipe_path,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_468430ba3e400391 = []byte{
	...
	,
}
...
func (m *WriteContentRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PipePath) > 0 {
		i -= len(m.PipePath)
		copy(dAtA[i:], m.PipePath)
		i = encodeVarintContent(dAtA, i, uint64(len(m.PipePath)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Labels) > 0 {
...
func (this *WriteContentRequest) String() string {
	...
	s := strings.Join([]string{`&WriteContentRequest{`,
		...
		`Data:` + fmt.Sprintf("%v", this.Data) + `,`,
		`Labels:` + mapStringForLabels + `,`,
		`PipePath:` + fmt.Sprintf("%v", this.PipePath) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
...
func (this *WriteContentResponse) String() string {
	...
	s := strings.Join([]string{`&WriteContentResponse{`,
		...
		`Total:` + fmt.Sprintf("%v", this.Total) + `,`,
		`Digest:` + fmt.Sprintf("%v", this.Digest) + `,`,
		`UsingPipePath:` + fmt.Sprintf("%v", this.UsingPipePath) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
...
func (m *WriteContentRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PipePath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PipePath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipContent(dAtA[iNdEx:])
...
func (m *WriteContentResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UsingPipePath", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
